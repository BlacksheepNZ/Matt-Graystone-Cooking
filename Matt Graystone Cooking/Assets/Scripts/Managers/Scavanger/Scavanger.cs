...
public class Scavanger
{
    ...
    public bool ShowUnlockNearGoal()
    {
        float value = DecreaseValue(Cost, 0.10f);
    ...
    public void Update()
    {
        ...
        float valueCurrency = IncreaseValue(CurrencyReward, B_IncreaseCurrencyRewardRate);
        ValueText.text = CurrencyConverter.Instance.GetCurrencyIntoString(valueCurrency * Count) + DisplayText(B_IncreaseCurrencyRewardRate);
    ...
    //First TimePurchase - startjourny
    //Upgrade Count
    //Upgrade HitPoint
    //  

    public bool buildingUnlock;
    ...
    public void FirstTimePurchase()
    {
        if (CanPurchase() == true)
        {
            ...
            ButtonFirstTimePurchase.gameObject.SetActive(false);
        }
    }

    public void SpawnVessel()
    {
        float valueTime = DecreaseValue(TimeToCompleteTask, B_DecreaseTimeToCompleteTask);
        //VesselSpawner.Instance.AddVessel(valueTime);
    }
    ...
    void ResetTimer()
    {
        ...
        Game.Instance.AddGold(valueCurrency * Count);
